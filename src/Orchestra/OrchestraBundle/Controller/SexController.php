...
use Orchestra\OrchestraBundle\Form\SexType;
...
class SexController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OrchestraOrchestraBundle:Sex')->findAll();

        return $this->render('OrchestraOrchestraBundle:Sex:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OrchestraOrchestraBundle:Sex')->find($id);
        ...
        return $this->render('OrchestraOrchestraBundle:Sex:show.html.twig', array(
            'entity'      => $entity,
    ...
    {
        $entity = new Sex();
        $form   = $this->createForm(new SexType(), $entity);

        return $this->render('OrchestraOrchestraBundle:Sex:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new SexType(), $entity);
        $deleteForm = $this->createDeleteForm($id);

        return $this->render('OrchestraOrchestraBundle:Sex:edit.html.twig', array(
            'entity'      => $entity,
