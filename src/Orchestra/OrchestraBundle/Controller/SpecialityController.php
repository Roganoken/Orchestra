...
use Orchestra\OrchestraBundle\Entity\Speciality;
use Orchestra\OrchestraBundle\Form\SpecialityType;
...
class SpecialityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OrchestraOrchestraBundle:Speciality')->findAll();

        return $this->render('OrchestraOrchestraBundle:Speciality:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OrchestraOrchestraBundle:Speciality')->find($id);
        ...
        return $this->render('OrchestraOrchestraBundle:Speciality:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('OrchestraOrchestraBundle:Speciality:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('OrchestraOrchestraBundle:Speciality:edit.html.twig', array(
            'entity'      => $entity,
