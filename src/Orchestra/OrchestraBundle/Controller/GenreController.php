...
use Orchestra\OrchestraBundle\Form\GenreType;
...
class GenreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OrchestraOrchestraBundle:Genre')->findAll();

        return $this->render('OrchestraOrchestraBundle:Genre:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        return $this->render('OrchestraOrchestraBundle:Genre:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('OrchestraOrchestraBundle:Genre:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('OrchestraOrchestraBundle:Genre:edit.html.twig', array(
            'entity'      => $entity,
